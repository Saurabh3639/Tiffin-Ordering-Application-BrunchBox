...
public class AdminOrdertobePrepareView extends AppCompatActivity {
    ...
    TextView grandtotal, note, address, name, number, time, fdate, tdate;
    LinearLayout l1;
    Button Preparing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_ordertobe_prepare_view);
        ...
        fdate = findViewById(R.id.fd);
        tdate = findViewById(R.id.td);
    ...
    private void AdminorderdishesView() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    data.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            hashMap1.put("Time", adminWaitingOrders1.getTime());
                                            hashMap1.put("FromDate", adminWaitingOrders1.getFromDate());
                                            hashMap1.put("ToDate", adminWaitingOrders1.getToDate());
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                time.setText(adminWaitingOrders1.getTime());
                fdate.setText(adminWaitingOrders1.getFromDate());
                tdate.setText(adminWaitingOrders1.getToDate());
