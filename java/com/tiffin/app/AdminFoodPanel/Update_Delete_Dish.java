...
public class Update_Delete_Dish extends AppCompatActivity {
    ...
    String description, quantity, price, dishes, AdminId;
    String RandomUId;
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        startActivity(new Intent(Update_Delete_Dish.this, AdminFoodPanel_BottomNavigation.class));
                                    }
                                });
    ...
    private void updatedesc(String uri) {
        ...
        FoodDetails info = new FoodDetails(dishes, quantity, price, description, uri, ID, AdminId);
