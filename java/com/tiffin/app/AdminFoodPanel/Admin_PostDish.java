...
public class Admin_PostDish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__post_dish);
    ...
    private void uploadImage() {
        ...
        if (imageuri != null) {
            final ProgressDialog progressDialog = new ProgressDialog(Admin_PostDish.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            FoodDetails info = new FoodDetails(dishes, quantity, price, description, String.valueOf(uri), RandomUId, AdminId);
                            firebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Sub).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Admin_PostDish.this, "Dish posted successfully", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(Admin_PostDish.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
