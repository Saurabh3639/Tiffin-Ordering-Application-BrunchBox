...
public class AdminRegisteration extends AppCompatActivity {

    String[] Maharashtra = {"Pune", "PimpriChinchwad", "Mumbai"};
    //String[] Gujarat = {"Ahemdabad", "Rajkot", "Surat"};

    String[] Pune = {"Baner", "Hadapsar", "Kothrud", "Undri", "Wagholi"};
    String[] PimpriChinchwad = {"Bhosari", "Hinjewadi", "Moshi", "Nigdi", "Wakad"};
    String[] Mumbai = {"Andheri", "Bandra", "Bhayander", "Borivali", "Charni-Road", "Churchgate",
        "Dadar", "Dahisar", "Goregaon", "Grant-Road", "Jogeshwari", "Kandivai", "Khar", "Lower-Parel",
        "Mahalakshmi", "Mahim", "Malad", "Marine-Lines", "Matunga", "MiraRoad", "Mumbai-Central",
        "Naigaon", "Nalla-Sopara", "Prabhadevi", "Ram-Mandir", "Santacruz", "Vasai-Road", "Vile-Parle", "Virar"};
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("Maharashtra")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AdminRegisteration.this, android.R.layout.simple_spinner_item, list);
...
//                }
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("Mumbai")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AdminRegisteration.this, android.R.layout.simple_spinner_item, listt);
                ...
                if (cityy.equals("PimpriChinchwad")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : PimpriChinchwad) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AdminRegisteration.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    ...
                    final ProgressDialog mDialog = new ProgressDialog(AdminRegisteration.this);
                                        ...
                                        firebaseDatabase.getInstance().getReference("Admin")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(AdminRegisteration.this);
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(AdminRegisteration.this, AdminVerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(AdminRegisteration.this, "Error", task.getException().getMessage());
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(AdminRegisteration.this, AdminLogin.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(AdminRegisteration.this, Adminloginphone.class);
                startActivity(e);
                finish();
            }
        });
