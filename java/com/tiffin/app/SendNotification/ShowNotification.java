...
import com.tiffin.app.AdminFoodPanel.AdminPreparedOrderView;
import com.tiffin.app.AdminFoodPanel_BottomNavigation;
import com.tiffin.app.CustomerFoodPanel.PayableOrders;
import com.tiffin.app.CustomerFoodPanel_BottomNavigation;
import com.tiffin.app.Delivery_FoodPanelBottomNavigation;
import com.tiffin.app.MainActivity;
...
public class ShowNotification {
    ...
    public static void ShowNotif(Context context, String title, String message, String page) {
        ...
        if (page.trim().equalsIgnoreCase("Order")) {
            acIntent = new Intent(context, AdminFoodPanel_BottomNavigation.class).putExtra("PAGE", "Orderpage");
        ...
        if (page.trim().equalsIgnoreCase("Confirm")) {
            acIntent = new Intent(context, AdminFoodPanel_BottomNavigation.class).putExtra("PAGE", "Confirmpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("AcceptOrder")) {
            acIntent = new Intent(context, AdminFoodPanel_BottomNavigation.class).putExtra("PAGE", "AcceptOrderpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        if (page.trim().equalsIgnoreCase("RejectOrder")) {
            acIntent = new Intent(context, AdminPreparedOrderView.class).putExtra("PAGE", "RejectOrderpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("Delivered")) {
            acIntent = new Intent(context, AdminFoodPanel_BottomNavigation.class).putExtra("PAGE", "Deliveredpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
