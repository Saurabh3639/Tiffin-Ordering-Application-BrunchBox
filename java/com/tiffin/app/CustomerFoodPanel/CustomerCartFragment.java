...
import com.tiffin.app.Customer;
...
public class CustomerCartFragment extends Fragment {
    ...
    String address, Addnote, FTime, Fromdate, Todate;
    String DishId, RandomUId, AdminId;
                                    ...
                                    FirebaseDatabase.getInstance().getReference("AlreadyOrdered").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("isOrdered").addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            if (ss.trim().equalsIgnoreCase("false") || ss.trim().equalsIgnoreCase("")) {
                                                ...
                                                final EditText Time = (EditText) view.findViewById(R.id.Ftime);
                                                final EditText FDate = (EditText) view.findViewById(R.id.FromDate);
                                                final EditText TDate = (EditText) view.findViewById(R.id.ToDate);
                                                        ...
                                                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                                                    ...
                                                                    Fromdate = FDate.getText().toString().trim();
                                                                    Todate = TDate.getText().toString().trim();

                                                                    final HashMap<String, String> hashMap = new HashMap<>();
                                                                    hashMap.put("AdminId", cart1.getAdminId());
                                                                    ...
                                                                    //time, from date and to date - CustomerPendingOrders
                                                                ...
                                                                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                    ...
                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                        ...
                                                                        //time, from date and to date - CustomerPendingOrders, OtherInformation
                                                                        hashMap1.put("Time", FTime);
                                                                        hashMap1.put("FromDate", Fromdate);
                                                                        hashMap1.put("ToDate", Todate);
                                                                                                ...
                                                                                                getRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        for (DataSnapshot dataSnapshot2 : dataSnapshot.getChildren()) {
                                                                                                            ...
                                                                                                            String userid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                                                                                                            AdminId = customerPendingOrders.getAdminId();
                                                                                                            ...
                                                                                                            //time, from date and to date - AdminPendingOrders
                                                                                                            //hashMap2.put("Time", FTime);
                                                                                                            //hashMap2.put("FromDate", Fromdate);
                                                                                                            //hashMap2.put("ToDate", Todate);

                                                                                                            FirebaseDatabase.getInstance().getReference("AdminPendingOrders").child(AdminId).child(RandomUId).child("Dishes").child(d).setValue(hashMap2);
                                                                                                        }
                                                                                                        ...
                                                                                                        dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                            ...
                                                                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                ...
                                                                                                                //time, from date and to date - AdminPendingOrders, OtherInformation
                                                                                                                hashMap3.put("Time", FTime);
                                                                                                                hashMap3.put("FromDate", Fromdate);
                                                                                                                hashMap3.put("ToDate", Todate);

                                                                                                                FirebaseDatabase.getInstance().getReference("AdminPendingOrders").child(AdminId).child(RandomUId).child("OtherInformation").setValue(hashMap3).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                                    @Override
                                                                                                                            ...
                                                                                                                            public void onSuccess(Void aVoid) {
                                                                                                                                ...
                                                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(AdminId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                                    ...
                                                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                        ...
                                                                                                                                        ReusableCodeForAll.ShowAlert(getContext(), "", "Your Order has been shifted to Pending state, please wait until the Admin accept your order.");
                                                                                                                                    }
