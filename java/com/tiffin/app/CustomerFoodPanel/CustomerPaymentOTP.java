...
import com.tiffin.app.CustomerFoodPanel_BottomNavigation;
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                            ...
                            hashMap.put("AdminId", customerPaymentOrders.getAdminId());
                        ...
                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                hashMap1.put("Time", customerPaymentOrders1.getTime());
                                hashMap1.put("FromDate", customerPaymentOrders1.getFromDate());
                                hashMap1.put("ToDate", customerPaymentOrders1.getToDate());
                                        ...
                                        Reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                    ...
                                                    AdminID = customerPaymentOrderss.getAdminId();
                                                    hashMap2.put("AdminId", customerPaymentOrderss.getAdminId());
                                                    ...
                                                    FirebaseDatabase.getInstance().getReference("AdminWaitingOrders").child(AdminID).child(RandomUID).child("Dishes").child(dishid).setValue(hashMap2);
                                                }
                                                ...
                                                dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                                                    ...
                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                        ...
                                                        //adding time, from date and to date - OtherInformation
                                                        hashMap3.put("Time", customerPaymentOrders1.getTime());
                                                        hashMap3.put("FromDate", customerPaymentOrders1.getFromDate());
                                                        hashMap3.put("ToDate", customerPaymentOrders1.getToDate());

                                                        FirebaseDatabase.getInstance().getReference("AdminWaitingOrders").child(AdminID).child(RandomUID).child("OtherInformation").setValue(hashMap3).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @Override
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                FirebaseDatabase.getInstance().getReference("AdminPaymentOrders").child(AdminID).child(RandomUID).child("Dishes").removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                    @Override
                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                        FirebaseDatabase.getInstance().getReference("AdminPaymentOrders").child(AdminID).child(RandomUID).child("OtherInformation").removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                            @Override
                                                                            public void onComplete(@NonNull Task<Void> task) {
