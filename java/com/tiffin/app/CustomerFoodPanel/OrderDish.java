...
import com.tiffin.app.AdminFoodPanel.UpdateDishModel;
...
public class OrderDish extends AppCompatActivity {
    ...
    TextView Foodname, AdminName, AdminLoaction, FoodQuantity, FoodPrice, FoodDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Sub).child(AdminID).child(RandomId);
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String qua = "<b>" + "Quantity: " + "</b>" + updateDishModel.getQuantity() + " /Day";
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (AdminID.equals(cart1.getAdminId())) {
                                        data = FirebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Sub).child(AdminID).child(RandomId);
                                    ...
                                    else
                                    {
                                        ...
                                        builder.setMessage("You can't add food items of multiple admin at a time. Try to add items of same admin");
