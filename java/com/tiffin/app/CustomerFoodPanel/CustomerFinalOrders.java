...
public class CustomerFinalOrders {
    ...
    public CustomerFinalOrders(String adminId, String dishId, String dishName, String dishPrice, String dishQuantity, String randomUID, String totalPrice, String userId) {
        AdminId = adminId;
        DishId = dishId;
        DishName = dishName;
        DishPrice = dishPrice;
