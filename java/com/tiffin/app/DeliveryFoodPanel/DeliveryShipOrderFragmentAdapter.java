...
public class DeliveryShipOrderFragmentAdapter extends RecyclerView.Adapter<DeliveryShipOrderFragmentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.CName.setText(deliveryShipFinalOrders1.getName());
        holder.Address.setText(deliveryShipFinalOrders1.getAddress());

        //display time, to date and from date from deliveryShipFinalOrders1
        holder.displytime.setText("Tiffin Time: " + deliveryShipFinalOrders1.getTime());
        holder.displyfromdate.setText("From Date: " + deliveryShipFinalOrders1.getFromDate());
        holder.displytodate.setText("To Date: " + deliveryShipFinalOrders1.getToDate());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView CName, Address, grandtotalprice, mobilenumber, displytime, displyfromdate, displytodate;
        Button Vieworder, ShipOrder;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);

            CName = itemView.findViewById(R.id.CN2);
            Address = itemView.findViewById(R.id.ad2);
            mobilenumber = itemView.findViewById(R.id.MB2);
            displytime = itemView.findViewById(R.id.tim);
            displyfromdate = itemView.findViewById(R.id.fdte);
            displytodate = itemView.findViewById(R.id.tdte);
