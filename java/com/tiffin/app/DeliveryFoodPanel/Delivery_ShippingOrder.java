...
public class Delivery_ShippingOrder extends AppCompatActivity {
    ...
    TextView Address, AdminName, grandtotal, MobileNumber, Custname;
    Button Call, Shipped;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //AdminName = (TextView) findViewById(R.id.adminname2);
    ...
    private void Shipped() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                //AdminName.setText("Admin " + deliveryShipFinalOrders1.getAdminName());
                userid = deliveryShipFinalOrders1.getUserId();
                Adminid = deliveryShipFinalOrders1.getAdminId();
                            ...
                            public void onSuccess(Void aVoid) {
                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        sendNotifications(usertoken, "Home Admin", "Thank you for Ordering", "ThankYou");
                                    }
