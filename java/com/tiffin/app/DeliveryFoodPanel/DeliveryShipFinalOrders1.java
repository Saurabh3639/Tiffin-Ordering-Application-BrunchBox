...
public class DeliveryShipFinalOrders1 {
    ...
    public DeliveryShipFinalOrders1(String address, String adminId, String adminName, String grandTotalPrice, String mobileNumber, String name, String randomUID,
                                    String userId, String time, String fromDate, String toDate) {
        Address = address;
        AdminId = adminId;
        AdminName = adminName;
