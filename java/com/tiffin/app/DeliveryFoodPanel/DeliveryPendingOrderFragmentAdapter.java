...
public class DeliveryPendingOrderFragmentAdapter extends RecyclerView.Adapter<DeliveryPendingOrderFragmentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DeliveryPendingOrderFragmentAdapter.ViewHolder holder, int position) {
        ...
        holder.CName.setText(deliveryShipOrders1.getName());
        holder.Address.setText(deliveryShipOrders1.getAddress());

        //display time, to date and from date from deliveryShipOrders1
        holder.displaytime.setText("Tiffin Time: " + deliveryShipOrders1.getTime());
        holder.displayfromdate.setText("From Date: " + deliveryShipOrders1.getFromDate());
        holder.displaytodate.setText("To Date: " + deliveryShipOrders1.getToDate());
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            adminid = deliveryShipOrderss.getAdminId();
                            hashMap.put("AdminId", deliveryShipOrderss.getAdminId());
                        ...
                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                hashMap1.put("AdminId", deliveryShipOrders11.getAdminId());
                                hashMap1.put("AdminName", deliveryShipOrders11.getAdminName());
                                ...
                                hashMap1.put("Time", deliveryShipOrders11.getTime());
                                hashMap1.put("FromDate", deliveryShipOrders11.getFromDate());
                                hashMap1.put("ToDate", deliveryShipOrders11.getToDate());
                                        ...
                                        FirebaseDatabase.getInstance().getReference("DeliveryShipOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(randomuid).child("Dishes").removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                FirebaseDatabase.getInstance().getReference("DeliveryShipOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(randomuid).child("OtherInformation").removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    @Override
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        FirebaseDatabase.getInstance().getReference("AdminFinalOrders").child(adminid).child(randomuid).child("Dishes").removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @Override
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                FirebaseDatabase.getInstance().getReference("AdminFinalOrders").child(adminid).child(randomuid).child("OtherInformation").removeValue();
                                                            }
                                                        });
                                                    }
                                                });
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                            ...
                            adminid = deliveryShipOrders.getAdminId();
                        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView CName, Address, grandtotalprice, mobilenumber, displaytime, displayfromdate, displaytodate;
        Button Vieworder, Accept, Reject;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);

            CName = itemView.findViewById(R.id.CN1);
            Address = itemView.findViewById(R.id.ad1);
            mobilenumber = itemView.findViewById(R.id.MB1);
            displaytime = itemView.findViewById(R.id.timm);
            displayfromdate = itemView.findViewById(R.id.fdat);
            displaytodate = itemView.findViewById(R.id.tdat);
